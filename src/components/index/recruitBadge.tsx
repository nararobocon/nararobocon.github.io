...
const RecruitBadge = () => {
    return (
        <Link href="/recruit">
            <div className="flex items-center justify-center text-white rounded-full bg-gradient-to-b from-slate-800 to-slate-900 w-fit">
...
export const CareerRecruitBadge = () => {
    return (
        <div className="flex items-center justify-center text-white rounded-full bg-gradient-to-b w-fit">
