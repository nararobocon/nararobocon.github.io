    ...
    return (
        <>
            ...
            <div className="w-full min-h-screen bg-pearl-100 text-dark-950 p-12 gap-3 grid grid-cols-1 lg:grid-cols-2 justify-center items-center">
                <div>
                    <div className="p-6 lg:text-6xl text-3xl underline ps-0 w-fit font-extrabold font-inter decoration-banana-500">活動内容</div>
            ...
            <div className="w-full min-h-screen flex gap-6 flex-col justify-center items-center">
                <div className="p-6 text-6xl underline ps-0 w-fit font-extrabold font-inter decoration-banana-500">活動場所/時間</div>
